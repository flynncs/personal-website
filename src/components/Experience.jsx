...
const Experience = () => {
  ...
  return (
    <div
      name="experience"
      className="bg-gradient-to-b from-stone-100 to-stone-200 w-full h-screen"
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-sage-dark">
        <div>
          <p className="text-4xl font-bold border-b-4 border-sage-light p-2 inline">
            Experience
          </p>
          <p className="py-6">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0">
          {techs.map(({ id, src, title }) => (
            <div
              key={id}
              className="shadow-md hover:scale-105 duration-500 py-2 rounded-lg shadow-stone-300"
            >
              {src}
