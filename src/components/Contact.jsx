      ...
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/0b43efee-88ea-4d86-8b79-39b252efbf08" method='POST' className='flex flex-col w-full md:w-1/2'>
            ...
            <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'> Contact</button>
          </form>
        </div>
      </div>
    </div>
